...
<c:if test="${not empty param.id}">
  <div class="hero-content flex-col lg:flex-row-reverse" style="width: 450px; margin:auto; display:flex; align-items:center; height:85vh;">
    <div class="">
	  ...
	  <div class="" style="background:#fff; width:450px; height:300px; border-radius: 0px 0px 20px 20px; padding-top:50px;"> 	
		
		<form id="managerResetPw" action="doresetpw" method="post" novalidate="novalidate">
	      	<!-- password -->
 ...
 <c:if test="${empty param.id}">
  <div class="hero-content flex-col lg:flex-row-reverse" style="width: 450px; margin:auto; display:flex; align-items:center; height:85vh;">
    <div class="">
	  ...
	  <div style="background:#fff; width:450px; height:200px; border-radius: 0px 0px 20px 20px; padding-top:50px; text-align:center;"> 	
				<span style="font-size:15px; font-weight:bold;">존재하지 않는 아이디입니다.</span>
	      <div style="text-align:center; margin-top:40px;">
				...
				<button style="height:40px; background:#585858; border-radius:5px; border:0; color:white; cursor:pointer; background:#084B8A;" onclick="location.href='login'" >처음으로</button>
	      </div>
    </div>
