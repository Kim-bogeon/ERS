...
<div class="container-fluid">
	<div class="row bg-primary bg-gradient" style="height:80px; line-height:80px; margin-top:20px;">
		<div class="col-5" >
   ...
   <div class="row">
      <div class="col-5">
         <!-- 직원목록 -->
         <div class="row" style="border:1px solid red;height:630px;">
            <div class="card card-body" style="border:1px solid red;">
            	<div>
      ...
      <!-- 상세정보 -->
      <div class="col-7" style="border:1px solid red;height:630px;">
         <div class="card card-body" style="border:1px solid red;height:630px;">
